...
3. **Audit logging** records every tool call, blocked attempt, and error for
   post-hoc review
4. **Execution timeout** (30 seconds) prevents runaway queries
5. **Size guard** (~800KB) truncates oversized responses
6. **Row-count warnings** help the model self-correct on large datasets
